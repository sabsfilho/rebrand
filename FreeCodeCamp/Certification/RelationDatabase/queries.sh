...
echo "$($PSQL "SELECT t.name FROM teams t, games g WHERE g.year=2014 and g.round='Eighth-Final' AND (g.winner_id=t.team_id OR g.opponent_id=t.team_id) ORDER BY t.name")"
